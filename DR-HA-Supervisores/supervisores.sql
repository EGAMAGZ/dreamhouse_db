...
VALUES ('Andador Sur Olivas,San Elena los altos,77962',4,'32m2',16307989, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 1);
-- DR-HA-CU4.3: DAR DE BAJA PROPIEDADES
UPDATE Propiedades SET bool_act_propd = 0 WHERE pk_id_propd IN (6,7);
-- DR-HA-CU4.2: DAR DE ALTA PROPIEDADES
UPDATE Propiedades SET bool_act_propd = 1 WHERE pk_id_propd = 6;
...
UPDATE Contratos SET bool_val_cont=1 WHERE pk_id_cont=3;
