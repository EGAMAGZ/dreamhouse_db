...
VALUES
    ...
    (
        'Pasaje Guillen,San Georgina los bajos,01804-7596',
        '5951140476'
    ),
    (
...
VALUES
    ...
    (
        'Dulce María Diana Garica',
        'hernanpichardo@dreamhouse.com',
        '5951140476',
        2
    ),
    (
        'José María Leiva',
        'cristianvalles@dreamhouse.com',
        '5951140476',
        3
    );
...
VALUES
    ...
    (
        'Adela Guajardo Velásquez',
        'yavila@dreamhouse.com',
        '5951140476',
        2
    ),
    (
        'Benito Héctor Gaona Arevalo',
        'ccasarez@dreamhouse.com',
        '5951140476',
        3
    ),
    (
        'Jos Wilfrido Camarillo Piña',
        'rlozada@dreamhouse.com',
        '5951140476',
        1
    ),
    (
        'Lourdes Mota Pantoja',
        'gregoriopichardo@dreamhouse.com',
        '5951140476',
        2
    ),
    (
        'Rosa Cornelio Feliciano Guillen',
        'robertosolis@dreamhouse.com',
        '5951140476',
        3
    );
...
VALUES
    (
        ...
        '5951140476',
        'galveztania@pedroza.com'
    ),
    (
        'Úrsula Fidel Gonzales Medina',
        'Boulevard Piña,Nueva Italia,34335',
        '5951140476',
        'esperanzaquintero@molina-medrano.com'
    ),
    (
        'Andrés Ilse Carmona Gutiérrez',
        'Privada Sur de la Garza,Nueva Maldivas,34567-4063',
        '5951140476',
        'fcaban@paredes.com'
    ),
    (
        'Leonardo Posada',
        'Circunvalación Brito,San María José los bajos,82545',
        '5951140476',
        'escobedooliver@laboratorios.com'
    ),
    (
        'Alejandro Garza Carmona',
        'Peatonal Sur Sierra,Vieja Lesotho,65971',
        '5951140476',
        'florezrosario@gaytan.biz'
    ),
    (
        'Noelia Treviño',
        'Peatonal Norte Tapia,Vieja Mauricio,92539-3737',
        '5951140476',
        'lucas56@grupo.net'
    );
...
VALUES
    ...
    (
        'Continuación Sinaloa,Nueva Eslovaquia,99036-2497',
        10,
        '32m2',
        94680228,
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
    ...
    (
        'Continuación Quintana Roo,Nueva Yemen,09742',
        3,
        '14m2',
        83217665,
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
    ...
    (
        'Andador Tamaulipas,Nueva República Centroafricana,17329-4426',
        4,
        '16m2',
        90047288,
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
    ...
    (
        'Avenida Jordania,Nueva México,19354',
        2,
        '50m2',
        27984961,
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
