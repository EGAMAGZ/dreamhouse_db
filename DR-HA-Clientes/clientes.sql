...
SELECT pk_id_propd,txt_ubi_propd, num_no_hab_propd,txt_tam_propd, num_prec_propd, txt_comp_propd FROM Propiedades WHERE bool_disp_propd = 1 AND bool_act_propd = 1;
